...
augroup("GitSignsHighlightning", function(group)
  autocmd("VimEnter", {
    group = group,
    callback = function()
      vim.cmd[[highlight GitSignsAdd        guifg='#4bf542']]
      vim.cmd[[highlight GitSignsChange     guifg='#f5ef42']]
      vim.cmd[[highlight GitSignsDelete     guifg='#f54242']]
    end
  })
end)
--
